...
public class ViewPagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener
{
    ...
    private void initializeViews(Context context, AttributeSet attrs)
    {
        ...
        if(attrs != null)
        {
            ...
            mIndicatorSpacing = (int) a.getDimension(R.styleable.ViewPagerIndicator_indicatorSpacing, 25);
    ...
    private void initializeIndicatorBar(int num)
    {
        ...
        for(int i = 0; i < num; i++)
        {
            ...
            img.setOnClickListener(this.onImageItemClicked);
            addView(img, lp);
        }
    ...
    OnIndicatorItemClickListener onIndicatorItemClickListener;
    ...
    public void setOnIndicatorItemClickListener(OnIndicatorItemClickListener l) {
        this.onIndicatorItemClickListener = l;
    }

    //View.OnClickListener onIndicatorItemClicked = new View.OnClickListener() {
    View.OnClickListener onImageItemClicked = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            //OnIndicatorItemClicked.onClick(v);
            //onIndicatorItemClicked.onClick(v);
            //Log.e("this is "," "+v.getTag());
            try {
                if(onIndicatorItemClickListener != null)
                onIndicatorItemClickListener.onItemClick(v);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void profarmIndicatorItmeClicked(View v) {
